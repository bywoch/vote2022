...
(function ($) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $sidoArea.on('click', function (e) {
                        e.preventDefault();
                        $('.vote-area-items-body').hide(); //시도 숨기기
        ...
        setDongList: function (url) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    mainHtml += '	</ul>';
                    mainHtml += '</div>';
                    $('.vote-area-dong').append(mainHtml);
    ...
    /* $('.vote-area-items-all a').on("click", function() {
             $('span.data-place').text('전국');
         });*/
    voteUIMap.init();
})(jQuery);
